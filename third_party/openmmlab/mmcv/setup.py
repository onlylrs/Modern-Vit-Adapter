...
def get_extra_cuda_paths():
    """Collect CUDA include/lib paths from micromamba or pip-style layouts."""
...
def get_extensions():
    ...
    if EXT_TYPE == 'parrots':
        ...
        include_dirs.extend(extra_cuda_paths['include_dirs'])
        cuda_args = os.getenv('MMCV_CUDA_ARGS')
        extra_compile_args = {
        ...
        # PyTorch 2.1+ requires extensions to be built with C++17 or later.
        # Keep the minimum standard aligned with the active torch headers.
