...
class MaskDINOOptimizerConstructor(DefaultOptimizerConstructor):
    ...
    This follows the official MaskDINO trainer: backbone parameters use a
    lower LR, normalization modules and embeddings use zero weight decay, and
    duplicate parameters are skipped.
    """
